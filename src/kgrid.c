...
static void get_all_grid_addresses(int grid_address[restrict][3],
...
static size_t get_grid_point_double_mesh(int const address_double[restrict 3],
                                         int const mesh[restrict 3]) {
    int i;
    int address[3];
...
static size_t get_grid_point_single_mesh(int const address[restrict 3],
                                         int const mesh[restrict 3]) {
...
static void modulo_i3(int v[restrict 3], int const m[restrict 3]) {
    int i;
...
static void reduce_grid_address(int address[restrict 3],
                                int const mesh[restrict 3]) {
    int i;
...
static void reduce_grid_address_double(int address[restrict 3],
                                       int const mesh[restrict 3]) {
    int i;
